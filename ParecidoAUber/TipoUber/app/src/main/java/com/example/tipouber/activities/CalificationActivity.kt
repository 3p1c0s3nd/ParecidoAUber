...
import com.example.tipouber.databinding.ActivityCalificationBinding
...
class CalificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            binding.ratingBar.setOnRatingBarChangeListener { ratingBar, value, _ ->
                calification = value
            }
        ...
        {
            mensajeLog.LOG("Error en la funcion onCreate (CalificationActivity) ${e.message}")
        }
    }
    ...
    private fun updateCalification(idDocument: String) {
        ...
        {
            mensajeLog.LOG("Error en la funcion updateCalification ${e.message}")
        }
    }
    ...
    private fun goToMap() {
        ...
        {
            mensajeLog.LOG("Error en la funcion goToMap (CalificationActivity) ${e.message}")
        }
    }
    ...
    private fun getHistory() {
        ...
        {
            mensajeLog.LOG("Error en la funcion getHistory (CalificationActivity) ${e.message}")
        }
    }
}