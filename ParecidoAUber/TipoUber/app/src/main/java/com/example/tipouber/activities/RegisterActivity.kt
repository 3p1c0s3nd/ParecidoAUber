...
import com.example.tipouber.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       {
           mensajeLog.LOG("Error en la funcion onCreate (RegisterActivity) ${e.message}")
       }
    }
    ...
    private fun register() {
        ...
        {
            mensajeLog.LOG("Error en la funcion register (RegisterActivity) ${e.message}")
        }
    ...
    private fun goToMap() {
       ...
       {
           mensajeLog.LOG("Error en la funcion goToMap (RegisterActivity) ${e.message}")
       }
    }
    ...
    private fun goToLogin() {
      ...
      {
          mensajeLog.LOG("Error en la funcion goToLogin (RegisterActivity) ${e.message}")
      }
    }
}