...
import com.example.tipouber.fragments.ModalBottomSheetMenu
import com.example.tipouber.models.Booking
import com.example.tipouber.models.DriverLocation
...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        {
            mensajeLog.LOG("Error en la funcion onCreate (MapActivity)")
        }
    }
    ...
    private fun removeBooking() {
        ...
        {
            mensajeLog.LOG("Error en la funcion removeBooking (MapActivity) ${e.message}")
        }
    }
...
//                            marker.position = LatLng(location.latitude, location.longitude)
        ...
        {
            mensajeLog.LOG("Error en la funcion getNearbyDrivers (MapActivity) ${e.message}")
        }
    }
    ...
    private fun goToTripInfo() {
        ...
        {
            mensajeLog.LOG("Error en la funcion goToTripInfo (MapActivity) ${e.message}")
        }
    ...
    private fun onCameraMove() {
       ...
       {
           mensajeLog.LOG("Error en la funcion onCameraMove (MapActivity) ${e.message}")
       }
    }
